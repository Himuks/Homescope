document.addEventListener('DOMContentLoaded', function() {
    ...
    listingsContainer.after(paginationContainer); // Insert pagination after listings
    ...
    function displayListings(page) {
        ...
        updatePagination(page, sortedListings.length); // Pass total filtered/sorted listings count
    }
    ...
    showMoreButton.style.display = 'none'; // Hide "Show More" button since we have pagination
